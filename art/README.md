...
## M2 制作与实际接入（2026-09-21）

八次内置 imagegen 制作小院、长辈、原料合集、设备合集、四相步态、四种冰淇淋成品、三种食物变体和两种配方纠正成品。来源与生成标识见 [m2-production.json](m2-production.json)：前六条明确是制作意图摘要，后两条保存实际提示词，不把摘要冒称原文。只使用本仓库冻结参考与本轮新稿；不重复索取身份确认。`export-m2.mjs` 按实际裁区机械裁切、Alpha 裁边、留边、只缩小。候选三明治/汉堡多出配料，已重新生成与规则相符的独立成品；行间裁区排除了相邻食物碎片。未将低清合集放大称为高清。
