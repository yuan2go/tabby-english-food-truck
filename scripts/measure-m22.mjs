...
await page.evaluate(() => (window.m22measure.running = true));
const tap = async (id) => {
...
await writeFile(
  `${process.env.EVIDENCE_DIR ?? 'docs/evidence/m22'}/performance-${label}.json`,
